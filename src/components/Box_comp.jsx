...
const Box_comp = ({ icons, title, paragraph, variants, transition, Containercontorl }) => {
  return (
    <motion.div
      ...
      className="backdrop-blur-lg bg-white/30 border border-white/20 rounded-3xl p-8 hover:bg-white/20 transition-all group hover:border-green-500/30 hover:shadow-lg hover:shadow-green-500/10"
    >
